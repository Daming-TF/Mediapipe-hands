...
from lib.hands.hands_tracker_gesture import HandsTrackerGestureLite2
...
parser.add_argument("--inp", default=r"./videos/source.mp4")
parser.add_argument(
    "--fps",
    default=30,
    type=int,
...
parser.add_argument("--save_path", default=r"./saves/lite.mp4")
...
def main():
    ...
    tracker = HandsTrackerGestureLite2(buffer_size=opts.buffer_size, hits=opts.hits, debug=opts.debug)
    writer = VideoWriter(
    ...
    while cap.isOpened():
        ...
        tracker.run(frame, is_print=True)
